...
SCIENTIC_NAME_LIST = [
                        ##"Alauda arvensis", # Columba palumbus, Alauda arvensis, Phylloscopus collybita, Regulus regulus, Anthus trivialis_Tree Pipit, Fringilla coelebs_Common Chaffinch, Troglodytes troglodytes_Eurasian Wren, Phoenicurus phoenicurus_Common Redstart, Strix aluco_Tawny Owl, Aegithalos caudatus_Long-tailed Tit
                        "Columba palumbus",
                        "Regulus regulus",
